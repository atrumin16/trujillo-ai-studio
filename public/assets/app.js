(function() {
  ...
  function setArtifactDest(dest, persist) {
    ...
    if (hint) {
      hint.textContent = artifactDest === 'guide'
        ...
        : 'Se publica en Artifact, en tu tablero /artifact/@' + h + '/… Hace falta cuenta registrada.';
    }
  }
  ...
  async function publishArtifact() {
    ...
    var prefix = dest === 'guide'
      ...
      : 'ai.trujillomingorance.com/artifact/@' + handle + '/';
  ...
  function renderArtifactsList(list, filterText) {
    ...
    filtered.forEach(function(a) {
      ...
      var destLabel = a.dest === 'guide' ? 'Guides' : 'Artifact';
      ...
      openPub.addEventListener('click', function(e) {
        ...
        window.open(a.url || (a.dest === 'guide'
          ...
          : ('/artifact/@' + (a.handle || '') + '/' + a.slug)), '_blank', 'noopener');
      });
