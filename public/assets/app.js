(function() {
  ...
  function readArtifactDraft() {
    ...
    var sel = document.getElementById('art-format');
    if (title) currentArtifact.title = (title.value || '').trim() || 'Artifact';
  ...
  function openArtifact(art, opts) {
    currentArtifact = art || { title: 'Artifact', content: '', lang: 'markdown' };
    fillArtFormatSelect();
    var kind = artifactKind(currentArtifact);
    ...
    var editor = document.getElementById('art-editor');
    var sel = document.getElementById('art-format');
    if (title) title.value = currentArtifact.title || 'Artifact';
  ...
  function initApp() {
    ...
    if (artTitle) {
      artTitle.addEventListener('input', function() { readArtifactDraft(); });
    }
